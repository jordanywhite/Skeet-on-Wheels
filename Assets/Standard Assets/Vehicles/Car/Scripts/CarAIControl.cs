    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            float approachingCornerAngle = Vector3.Angle(m_ArrayOfTargets[m_arrayIndex].forward, fwd);
                    ...
                    case BrakeCondition.TargetDistance:
                        {
                            ...
                            Vector3 delta = m_ArrayOfTargets[m_arrayIndex].position - transform.position;
                ...
                Vector3 offsetTargetPos = m_ArrayOfTargets[m_arrayIndex].position;
                ...
                if (Time.time < m_AvoidOtherCarTime)
                {
                    ...
                    offsetTargetPos += m_ArrayOfTargets[m_arrayIndex].right * m_AvoidPathOffset;
                }
                else
                {
                    // no need for evasive action, we can just wander across the path-to-target in a random way,
                    // which can help prevent AI from seeming too uniform and robotic in their driving
                    offsetTargetPos += m_ArrayOfTargets[m_arrayIndex].right *
                ...
                {
                    //m_Driving = false;
                    ++m_arrayIndex; //next waypoint
                    if (m_ArrayOfTargets.Length == m_arrayIndex)
                    {
                        Debug.Log("arrayIndex: " + m_arrayIndex);
                        Debug.Log("array: " + m_ArrayOfTargets.Length);
                        m_Driving = false;
                    }
                    else
                    {
        ...
        {
            m_ArrayOfTargets[m_arrayIndex] = target;
            m_Driving = true;
        }
    }
}
